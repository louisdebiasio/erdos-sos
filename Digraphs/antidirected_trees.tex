...
number.  Section~\ref{sec:signed-injections} proves the two counting
inequalities, and Section~\ref{sec:density-proof} completes the
...
We next add a leaf and make it the new root.  Reversing the prefix
interchanges the first and marked vertices.  The marking arc itself
...
as the paper.  The tournament corollary has not been formalized.
